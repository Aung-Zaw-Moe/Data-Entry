...
<body class="bg-dark text-light">
    ...
    <div class="container" style="max-width: auto; backdrop-filter: blur(15px); ">

        <h1 class=" text-center text-light">User Management System</h1>



        <form action="index.php" method="POST" class="mb-3  text-light">
            <div class="row">
